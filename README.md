...
- **In docs**: [docs/runbook.md](docs/runbook.md) for the alert to the map,
  [docs/symptom-map.md](docs/symptom-map.md) for the 65 nodes.
...
| `docs/symptom-map.md`, `.json` | The operator's decision tree, and the checked subset the site evaluates | 65 nodes; the JSON's 37 nodes held equal by a test |
